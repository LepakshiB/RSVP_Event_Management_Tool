      ...
      <h1>Login </h1>
        ...
        <p class="submit">
          <asp:Button ID="Button1" runat="server" Text="Login" onclick="Button1_Click" />
              ...
              <p>Forgot your password? <a href="">Reset Your password. Other wise create new account Please Don't Forgret your password offtenly. testing testing 2 more repository</a>.</p>
        <p>
